...
<div class="frame">
       ...
       <a class="ka_button small_button small_cherry search_form" href="<?=base_url();?>index.php/application">Apply Now</a><p class="breadcrumb"><a href="<?php echo BASETHEMEPATH;?>index.php/home">Home</a><a href="<?php echo BASETHEMEPATH;?>index.php/about-us">About Us</a><span class='current_crumb'>Privacy Policy</span></p> 
...
<h3> Online Privacy Policy</h3>
      ...
      <p>Your personal information is protected with us. Who use SSL security</p>

      <p> We are committed to protection the privacy of visitors to our website, as specified in this privacy policy. By applying for a visa to Turkey with www.turkeyvisapro.com, you agree to accept the following conditions of our privacy statement. </p>

      <p>We will collect, personal data - information that is required to complete a visa application such as your full name, passport number, date of birth, nationality, expiry date and date of arrival in Turkey.</p>

      <p>Personal data submitted on this website will be used for processing the Turkey visa pre-approval letter by Turkey Visa Pro. And your information will be stored at the Turkey Immigration System until you exit Turkey after arriving</p>
      ...
      <p>TurkeyVisaPro Visa Service uses cookies and other technologies to enhance your online experience and allow you to quickly and easily complete our online application process.</p>

      <p> Once the Visa is issued by Turkey Immigration Department, you cannot update the information but you can reapply for a new visa.</p>

      <p> We have right to collect and store such information as IP address, browser type or operating system type. All the information is highly confidential and this information helps diagnose problems, monitor traffic and site usage.</p>

      <p>In the website we have integrated online payment tool, PayPal pocket electronic payment. For ease of payment, we accept credit cards, PayPal and direct bank transfer online. So, all credit card information, your PayPal account is required to pay visa fees, and is done through third </p>

      <p>If you have questions or concerns about this policy please contact us at: info@turkeyvisapro.com</p>
