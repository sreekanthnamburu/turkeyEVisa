  ...
  <div class="main-area"> 
    ...
    <div class="tools"> <span class="tools-top"></span>
      ...
      <a class="ka_button small_button small_cherry search_form" href="<?=base_url();?>index.php/application">Apply Now</a>
					...
					<p class="breadcrumb"><a href="<?php echo BASETHEMEPATH;?>index.php/home">Home</a><a href="<?php echo BASETHEMEPATH;?>index.php/about-us">About Us</a><span class='current_crumb'>About Us </span></p>
    ...
    <main role="main" id="content" class="content_blog">
     ...
     <p>We are not an affiliate of any official Government of Turkey service, embassy or government department. We provide without difficulty online visa registration services which will be verified by our service experts to avoid errors. Please refer to respective embassy and Visa fee information page.<p>
<p>Our team is available to offer you whatever help you need like If any issues or errors with your application we found based on your application, so don't hesitate to contact us at anytime.</p>
<p>Applicants obtain their Turkish visa electronically; the e-Visa application can be submitted <a href="http://turkeyvisapro.com/index.php/application">online</a>. Tourists and short-term business travelers have travel document must be valid for at least 6 months from the date you intend to enter Turkey.</p>
<p>Your personal information is protected with us with help of SSL security. We are committed to protection the privacy of visitors to our website, as specified in this privacy policy. By applying for a visa to Turkey with <a href="http://turkeyvisapro.com/index.php/application">www.turkeyvisapro.com</a>, you agree to accept the following conditions of our privacy statement.</p>
<p>We will help you to visit the beautiful Turkey without visa problems.</p>
