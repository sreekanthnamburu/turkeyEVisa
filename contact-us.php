          ...
          <div class="row">
            ...
            <div class="col-md-4 col-xs-12 pull-right">
              ...
              <div class="contact-box">
                ...
                <div class="contact-box-phon">  Web Mojo Ltd, Redhill House, 41 Hope Street, Chester, England CH4 8BU</div>
              ...
              <div class="contact-box">
                ...
                <div class="contact-box-name"><span class="highlight">UK Customers Toll Free </span></div>
                <div class="contact-box-phon"><span class="highlight">Phone:</span> 08001337619</div>
            ...
            <div class="col-md-8 col-xs-12 pull-left">
              <p class="contact-info">To contact our Customer Service Team online, please fill the form and send message <br>
               <span class="address"><span class="highlight">Address:</span>  Web Mojo Ltd, Redhill House, 41 Hope Street, Chester, England CH4 8BU</span></p>
                <form  action="<?php echo BASETHEMEPATH('contact-us/send'); ?>" method="post" id="contact-form" name="contact-form">
