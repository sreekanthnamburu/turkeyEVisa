                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Templates</li>
                                <li><a class="link-effect" href="">New Template</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <form class="js-validation-edit-template form-horizontal push-10-t" action="<?php echo site_url(uri_string())?>" method="post">
                                        <div class="form-group">
                                            <div class="col-sm-9">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="templatename"  name="templatename" placeholder="Choose a Template Name..">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea class="js-summernote" name="templateData"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <input type="checkbox" id="status" name="status"><span></span>
                                </label>
                                                </div>
                                            </div>
                                        </div>
