                        ...
                        <div class="block-content">
                            ...
                            <form class="js-validation-edit-group form-horizontal push-10-t" action="<?php echo current_url()?>" method="post">
                                        <div class="form-group">
                                            <div class="col-sm-9">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="group_name" value="" name="group_name" placeholder="Choose a Group Name..">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-9">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" value=""  id="group_description" name="group_description" placeholder="Enter your Description..">
