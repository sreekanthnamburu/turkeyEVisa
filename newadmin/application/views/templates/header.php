...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Visa Admin - <?=$title?> </title>

        <meta name="description" content="Visa Admin - Admin Dashboard">
        <meta name="author" content="webtag">
        ...
        <link rel="stylesheet" href="<?php echo base_url();?>assets/js/plugins/summernote/summernote-bs3.min.css">
