...
class Auth extends CI_Controller {
	...
	function index()
	{
		...
		else
		{
			...
			$this->data['header_title'] = "All Users";
			...
			$this->_render_pageS('auth/index', $this->data);
		}
	}
	// redirect if needed, otherwise display the user list
	function users()
	...
	function create_user()
	{
		...
		if (!$this->ion_auth->logged_in() || !$this->ion_auth->is_admin())
		{
			redirect('auth', 'refresh');
				...
				$this->data['title'] = "Create User";
		$this->data['header_title'] = "Create User";
		$this->data['user'] = $this->ion_auth->user($id)->row();
		...
		else
		{
			...
			$this->_render_pages('auth/create_user', $this->data);
		}
	}
	...
	function edit_user($id)
	{
		...
		$this->data['title'] = "Edit User";
		$this->data['header_title'] = "Edit User";
		// validate form input
		...
		$this->_render_pages('auth/edit_user', $this->data);
	}
	...
	function create_group()
	{
		...
		else
		{
			...
			$this->data['header_title'] = "Create Group";
			$this->data['user'] = $this->ion_auth->user($this->session->userdata('user_id'))->row();
			...
			$this->_render_pages('auth/create_group', $this->data);
		}
	}
	...
	function edit_group($id)
	{
		...
		$this->_render_pages('auth/edit_group', $this->data);
	}
